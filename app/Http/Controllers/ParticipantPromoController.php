...
class ParticipantPromoController extends Controller
{
     ...
     function __construct(Request $request, ParticipantRepository $repo)
    {
    	...
    	$this->promolink = "https://targiehandlu.pl/?utm_source=partner_".$partner_id."&utm_medium=".str_slug(array_get($this->partner, "fields.cname2"))."&utm_campaign=visitors_TEH13";
