...
(** You can forward this message to a person responsible for PR in your company. **)
...
For now, the **top 3 companies are:** 

A4G DSP (over 629 points), 

knowhere (596 points), 

hello.de AG (520 points).

([Full ranking](https://account.ecommerceberlin.com/#/ranking))

## Quickstart quide. Promo materials with your "tracking link"
...
## Do you want to schedule a 10 min chat with us?

...we can briefly **discuss how to use promotional materials**. Please use [this link]({!! $calendar !!}) below to choose the most suitable time for you.
