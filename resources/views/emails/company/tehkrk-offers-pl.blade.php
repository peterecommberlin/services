...
Oferta musi być **dostępna tylko dla Zwiedzających** (może być limitowana ilościowo, czasowo, wielkością firmy...)
...
Oferta musi być atrakcyjna (**"sexy"** jak to mawiają marketerzy...)

# Przykłady dobrych Super Ofert

@component('mail::panel')
Klienci, którzy spotkają się z naszym zespołem na targach eHandlu w Krakowie otrzymają ofertę z: Bezpłatną obsługą zwrotów - na jakikolwiek magazyn zagraniczny (...) trafi twoja zwrotna przesyłka, otrzymasz ją bezpłatnie pod Twój adres w Polsce.
@endcomponent
...
@component('mail::panel')
Odwiedź nasze stoisko B5.8 i skorzystaj z darmowych testów!
@endcomponent
