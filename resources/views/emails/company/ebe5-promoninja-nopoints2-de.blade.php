...
** Zur Zeit sind das die Top 3:**

A4G DSP (629 Punkte), 

knowhere (596 Punkte), 

hello.de AG (520 Punkte).

([vollständige Rangliste](https://account.ecommerceberlin.com/#/ranking))

## Quickstart-Guide (Werbematerial mit deinem personaliserten Link)
...
## Würdest du mit uns einen 10-minütigen Call machen? 

Dann erklären wir dir wie das Prozedere aussieht. Bitte [benutze den Link hier]({!! $calendar !!}) und wähle den für dich besten Zeitpunkt. 
