...
Co tu dużo pisać, jesteśmy zadowoleni i wierzemy, że każda osoba która wybierze się w środę (25 kwietnia) do EXPO Kraków będzie z swojej decyzji zadowolona.
...
Wstęp jest bezpłatny. Pobierz bilet tutaj! {{$registerURl}}

### Oto lista tematów:

* Kupowanie w mobile'u – co musisz wiedzieć o zwyczajach zakupowych Twoich użytkowników
* Naucz swój sklep sprzedawać. Czy e-commerce jest gotowy na sztuczną inteligencję?
* YouTube for Performance - rozwiązania dla e-commerce
* RCS, czyli następca SMS, wchodzi do Polski! Poznaj możliwości rozwiązania, które zrewolucjonizuje marketing mobilny.
* Nie trać klientów, czyli e-maile transakcyjne w e-commerce
* Szybkie sposoby na podniesienie konwersji.
* AMAZON – KROK PIERWSZY, czyli jak wygrać maraton biegnąc po polu minowym
* Generowanie sprzedaży w e-commerce poprzez Google AdWords
* Amazon – szanse i ryzyka na podstawie case study StukPuk.pl i ekspansji na rynki zagraniczne
* Jak stworzyć globalny dream team w sprzedaży online?
* 10 marketingowych sztuczek, które musisz znać prowadząc e-commerce
* Jak odzyskiwać klientów i porzucone koszyki wykorzystując rozmowę telefoniczną?
* Sprzedawaj przy pomocy Messengera. O botach i nie tylko.
* RODO w e-commerce: jak pozbyć się check-boxów z WWW Twojego sklepu?
* Jak wprowadzić firmę na Allegro?
* Trendy w światowej logistyce i e-commerce w czasach cross-border
* O budowaniu marki i spójności wizerunku w wielu kanałach – jak skutecznie połączyć online z offline.
* Jak ułatwić sobie (i klientom) obsługę w BOK - case study z InPost
* Co irytuje klientów e-commerce? Jak dbać o UX sklepu internetowego?
* Narzędzia wzrostu dla małych i średnich e-sklepów
* 1500 testów w minutę i jeden system gotowy na dekady. Jak CI zmieni oblicze e-commerce?
* Prezentacja Niespodzianka Zwycięzcy konkursu wśród Wystawców
* Panel Dyskusyjny: Płatności internetowe A.D. 2018
* Panel Dyskusyjny: Platformy SaaS vs rozwiązania "szyte na miarę"

Wstęp na wszystkie prezentacje i EXPO jest bezpłatny. Pobierz bilet tutaj! {{$registerURl}}
...
* Ponad 22 Prelegentów, którzy mają za sobą realne osiągnięcia
* Formuła open space, realna wartość networkingu
