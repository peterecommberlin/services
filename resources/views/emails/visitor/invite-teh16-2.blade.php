...
Handel na **ebay.com**, **amazon.com**, wyższość **progressive web apps** nad aplikacjami mobilnymi, rewolucja związana z wejściem **PSD2**, strategia **omnichannel**, **opakowania** to tylko część agendy wystąpień Ekspertów **16 Targów eHandlu w Krakowie.**

# 17 kwietnia w Krakowie odbędą się największe targi przeznaczone dla sprzedających w Internecie w tej części Europy. 

@component('mail::button', ['url' => $registerURl])
	Chcę bilet na 34 prezentacje
@endcomponent

<a href="{{$registerURl}}"><img src="https://res.cloudinary.com/eventjuicer/image/upload/c_fit,w_650/v1555284192/teh_promo_1.jpg" style="max-width: 600px; margin: 20px 0;" alt="" /></a>
