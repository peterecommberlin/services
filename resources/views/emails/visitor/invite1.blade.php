...
If your contact details are no more valid we advise you to [register here]({{$siteUrl}}) - it takes only approx. 60 seconds!
...
**[Check the full agenda and speakers here]({{$siteUrl}}/schedule)**

@endcomponent

New registration: [Register here]({{$siteUrl}})
